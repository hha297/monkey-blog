...
const UserUpdate = React.lazy(() =>
    import('module/user/UserUpdate'),
);
const UserAddNew = React.lazy(() =>
    import('module/user/UserAddNew'),
);
const UserManage = React.lazy(() =>
    import('module/user/UserManage'),
);
const UserProfile = React.lazy(() =>
    import('module/user/UserProfile'),
);
const PostAddNew = React.lazy(() =>
    import('module/post/PostAddNew'),
);
const PostManage = React.lazy(() =>
    import('module/post/PostManage'),
);
const PostUpdate = React.lazy(() =>
    import('module/post/PostUpdate'),
);
